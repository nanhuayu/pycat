...
from pycat.models.conversation import tool_call_name as _canonical_tool_call_name


def tool_call_name(tool_call: Dict[str, Any] | None) -> str:
    """Tool display name; keeps the historical ``unknown_tool`` fallback."""
    return _canonical_tool_call_name(tool_call) or "unknown_tool"
