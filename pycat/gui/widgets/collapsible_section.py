...
class CollapsibleSection(QFrame):
    ...
    def __init__(
        ...
        *,
        ...
        self.header = header
        self.header.setFixedHeight(COMPACT_CONTROL_HEIGHT)
    ...
    def set_collapsed(self, collapsed: bool) -> None:
        ...
        self.header.setProperty("expanded", not self._collapsed)
        self.body.setProperty("expanded", not self._collapsed)
