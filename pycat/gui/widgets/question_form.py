"""Inline question fields, validation and answer serialization."""
...
class QuestionForm(QFrame):
    ...
    def _setup_ui(self) -> None:
        ...
        question_text = str(self.question.get("text") or "请输入你的回答").strip() or "请输入你的回答"
        ...
        self._freeform_input.setPlaceholderText("输入回答或补充说明…")
        self._freeform_input.setAccessibleName("回答或补充说明")
    ...
    def _submit(self) -> None:
        ...
        if answer["selected"] or answer["freeText"]:
            self.validation_label.setVisible(False)
