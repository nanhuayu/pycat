...
from pycat.core.app.services.release import ReleaseCheckResult, STABLE_RELEASE_PAGE
...
class AboutPage(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        features_card.setObjectName("settings_info_row")
        ...
        release_card = QFrame()
        # Actionable card (check/open/ignore buttons): stays a tinted
        # settings_row_card; only the read-only cards above go transparent.
