...
from pycat.core.commands.parser import find_command_invocation, parse_command_text
from pycat.core.commands.types import CommandAction, CommandResult, SlashCommand
...
def dispatch_command(
    ...
    *,
    ...
    if not invocation or invocation.leading_text:
        return None
