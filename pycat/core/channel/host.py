...
class ChannelHost:
    ...
    def enqueue_channel_message(self, channel: ChannelConfig, content: str, *, meta: dict[str, Any] | None = None, media=None) -> None:
        self._gateway.enqueue_channel_message(channel, content, meta=meta, media=media)
