...
from pycat.core.channel.connection import ChannelServerHandle
from pycat.core.channel.host import ChannelHost
from pycat.core.channel.http_server import start_http_server
from pycat.core.channel.platforms.wechat.protocol import (
...
def start_wechat_webhook_server(context: ChannelHost, channel: ChannelConfig) -> ChannelServerHandle | None:
    ...
    handle = start_http_server(
        ...
        httpd=httpd,
        thread_name=f"PyCat-WeChat-{channel.id}",
    )
    logger.info(
