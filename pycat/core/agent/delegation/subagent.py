...
def build_child_run(
    *,
    ...
    parent_work_dir = str(getattr(parent_conversation, "work_dir", "") or "")
    mode_manager = ModeManager(parent_work_dir, data_dir=parent_conversation.data_dir)
    ...
    child_conversation = Conversation(
        data_dir=parent_conversation.data_dir,
