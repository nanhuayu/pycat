...
def resolve_mode_config(
    ...
    *,
    ...
    return (mode_manager or ModeManager(work_dir, data_dir=data_dir)).get(normalize_mode_slug(mode_slug))


class ModeManager:
    def __init__(self, work_dir: str | None = None, *, include_project: bool = True, data_dir: str | None = None):
        self.data_dir = data_dir
        self.work_dir = str(work_dir or "").strip()
        self.include_project = bool(include_project and self.work_dir)
    ...
    def _ensure_loaded(self) -> None:
        ...
        try:
            global_payload = load_user_modes_dict(data_dir=self.data_dir)
