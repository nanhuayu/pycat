...
class TerminalPage(QWidget):
    ...
    def __init__(self, shell_config: ShellConfig, parent=None, *, embedded: bool = False):
        super().__init__(parent)
        self._setup_ui(shell_config or ShellConfig(), embedded=embedded)

    def _setup_ui(self, shell_config: ShellConfig, *, embedded: bool = False) -> None:
