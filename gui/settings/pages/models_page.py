...
from gui.settings.provider_editor import ProviderEditor
...
class ModelsPage(QWidget):
    ...
    def _setup_ui(self) -> None:
        ...
        root.setSpacing(10)
        root.addWidget(build_page_header("模型", "管理默认模型、服务商连接和单模型能力参数。"))
    ...
    def _sync_actions(self) -> None:
        ...
        self.btn_delete_provider.setEnabled(has_item)
        self.btn_move_up.setEnabled(has_item and row > 0)
        self.btn_move_down.setEnabled(has_item and 0 <= row < count - 1)
