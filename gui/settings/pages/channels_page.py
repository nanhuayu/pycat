...
from core.channel import ChannelDefinition, ChannelInstance
...
from gui.dialogs.channel_instance_dialog import ChannelInstanceDialog
from gui.dialogs.channel_session_picker_dialog import ChannelSessionPickerDialog
...
class ChannelsPage(QWidget):
    ...
    def _render_instance_overview(self, channel: ChannelConfig) -> None:
        ...
        if channel_type == "wechat":
            ...
            hint_lines.append("推荐使用长连接模式；Webhook 适合已有公网回调的高级场景。")
        else:
