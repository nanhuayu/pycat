...
class QuestionsDialog(QDialog):
    ...
    def _setup_ui(self) -> None:
        header = str(self._question.get("id") or "需要你的选择").strip() or "需要你的选择"
        question_text = str(self._question.get("text") or "请选择一个选项").strip() or "请选择一个选项"
    ...
    def _build_option_widget(self, option: Any, index: int) -> QWidget:
        ...
        multi_select = bool(self._question.get("multiple", False))
