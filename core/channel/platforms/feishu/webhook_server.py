...
from core.channel.http_server import start_http_server
...
def start_feishu_webhook_server(context: ChannelHost, channel: ChannelConfig) -> ChannelServerHandle | None:
    ...
    handle = start_http_server(
        ...
        httpd=httpd,
        thread_name=f"PyCat-Feishu-{channel.id}",
    )
    logger.info(
