...
from core.channel.platforms.wechat.polling_transport import start_wechat_polling
from core.channel.platforms.wechat.webhook_server import start_wechat_webhook_server
