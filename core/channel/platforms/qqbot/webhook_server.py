...
from core.channel.platforms.qqbot.router import normalize_qqbot_webhook_payload
...
def start_qqbot_webhook_server(context: ChannelHost, channel: ChannelConfig) -> ChannelServerHandle | None:
    ...
    handle = start_http_server(
        ...
        httpd=httpd,
        thread_name=f"PyCat-QQBot-{channel.id}",
    )
