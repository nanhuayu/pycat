...
from core.agent.delegation.subagent import build_child_run, run_child_agent
from core.agent.run.state import AgentRunResult
...
class SubagentRunner:
    ...
    def _import_child_artifacts(
        *,
        ...
        work_dir = str(getattr(conversation, "work_dir", "") or getattr(child_result.context.conversation, "work_dir", "") or ".")
